...
public class ExamenTheorique extends Examen {
	
	public ExamenTheorique (  AnneeFiliere candidats , Module module , LocalDate date , LocalTime tempsDebut , int dureeMinute  ) {
